...
keys.desktopbuttons = gears.table.join(
    ...
    awful.button({ }, 9, function () awful.spawn.with_shell("pamixer -i 2") end),
    awful.button({ }, 8, function () awful.spawn.with_shell("pamixer -i 2") end)
...
keys.globalkeys = gears.table.join(
    awful.key({ superkey          }, "z",      hotkeys_popup.show_help,
    ...
    awful.key({ superkey }, "Tab",
      function ()
        awful.spawn.with_shell("rofi -show window -theme window")
      end,
      {description = "Rofi Window Switcher", group = "client"}
    ),
    ...
    awful.key({ ctrlkey, altkey }, "Left",
        function ()
            awful.tag.viewprev()
        end,
        {description = "go to previous tag", group = "navigation"}
    ),
    awful.key({ ctrlkey, altkey }, "Right",
        function ()
            awful.tag.viewnext()
        end,
    ...
    -- Standard program
    awful.key({ superkey,           }, "Return", function () awful.spawn("alacritty") end,
    ...
    -- Prompt
    --awful.key({ superkey,shiftkey },            "d",     function () awful.screen.focused().mypromptbox:run() end,
    --          {description = "run prompt", group = "launcher"}),
    -- Run program (d for dmenu ;)
    awful.key({ superkey}, "d",
      function ()
        awful.spawn("rofi -show drun -theme default")
	end,
    ...
    awful.key({ superkey }, "s",
      ...
      {description = "change layout", group = "launcher"}),

    awful.key({ superkey }, "a",
        function ()
            awful.spawn(string.format("dmenu_run -b -i -nb '".. beautiful.dmenu_background .."' -nf '".. beautiful.dmenu_text .."' -sb '".. beautiful.dmenu_text .."' -sf '".. beautiful.dmenu_background .."' -fn NotoMonoRegular:bold:pixelsize=14",
    ...
    awful.key({ superkey }, "r",
              function ()
                  awful.prompt.run {
                    prompt       = " Lua: ",
                    terxtbox      = awful.screen.focused().mypromptbox.widget,
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            os.execute("pamixer -i 2")
            --beautiful.volume.update()
        end),
    --awful.key({ modkey1 }, "Down",
    awful.key({ }, "XF86AudioLowerVolume",
        function ()
            os.execute("pamixer -d 2")
            --beautiful.volume.update()
        end),
    ...
    -- Quick edit file
    awful.key({ superkey }, "e", function() awful.spawn.with_shell('rofi -modi "Files:.local/share/rofi/browserfinder.sh" -show Files -theme default') end,
        {description = "Rofi Files", group = "launcher"}),
    awful.key({ superkey,shiftkey }, "z", function() awful.spawn.with_shell('rofi -modi "Notes:.local/share/rofi/note.sh" -show Notes -theme default') end,
        {description = "Rofi Files", group = "launcher"}),
    -- mpvtube
