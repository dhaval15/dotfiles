...
local ftenmap = {
    ...
    },
    {
        "0",
        function()
            awful.spawn("rofi  -show Find -theme finder -modi Find:rofi_finder")
        end,
        "Finder",
        "0",
    },
...
local globalKeys = awful.util.table.join(
    ...
    awful.key(
        ...
        'e',
        function()
            awful.spawn("rofi -show file-browser -theme files -file-browser-icon-theme 'Surfn-Luv-Red' -file-browser-open-custom-key 'kb-custom-1' -file-browser-oc-cmd 'nemo;name: Open in File Manager;icon:system-file-manager' -file-browser-show-hidden -file-browser-oc-cmd 'hashcode;name: Open With Hash Code;icon:moeditor' -file-browser-oc-cmd 'spacevim;name: Open With SpaceVim;icon:sublime-text' -file-browser-oc-cmd 'kitty;name: Open in Terminal;icon:hyperterm'")
        end,
